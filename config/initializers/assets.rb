...
Rails.application.config.assets.precompile += %w( farma-04.jpg )
Rails.application.config.assets.precompile += %w( farma-05.jpg )
Rails.application.config.assets.precompile += %w( farma-06.jpg )
Rails.application.config.assets.precompile += %w( farma-07.jpg )
Rails.application.config.assets.precompile += %w( missing.png )
Rails.application.config.assets.precompile += %w( favicon.ico )
Rails.application.config.assets.precompile += %w( logo-farma.svg )
